...
public class blackpink extends Concert {
    ...
    public static void displayBP_stock(){
        System.out.print("[1] CAT1 [900]: " + bp_cat1);
        System.out.print("\n[2] CAT2 [800]: " + bp_cat2);
        System.out.print("\n[3] CAT3 [700]: " + bp_cat3);
        System.out.print("\n[4] CAT4 [600]: " + bp_cat4);
        System.out.print("\n[5] CAT5 [500]: " + bp_cat5);
    ...
    public String toString(){
        return super.toString() + "[1] CAT1 [900] , " + "Tickets remaining : " + bp_cat1 + 
                                  "\n[2] CAT2 [800] , " + "Tickets remaining : " + bp_cat2 +  
                                  "\n[3] CAT3 [700] , " + "Tickets remaining : " + bp_cat3 +  
                                  "\n[4] CAT4 [600] , " + "Tickets remaining : " + bp_cat4 + 
                                  "\n[5] CAT5 [500] , " + "Tickets remaining : " + bp_cat5;
    }
