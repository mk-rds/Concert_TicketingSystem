    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                ...
                System.out.println("Try again please, only integers are allowed");
                        ...
                        do {
                            ...
                            try {
                                ...
                                if (option != 1 && option != 2) {
                                    System.out.println("Try Again,this concert does not exist ");                     //VALIDATION FOR SELECTING CONCERT

                                }

                            } catch (Exception ex) {
                                System.out.println("Try again please, only integer are allowed");
                                ...
                                do {
                                    do {
                                        ...
                                        try {
                                            ...
                                            selection = input.nextInt();
                                            if (selection != 1 && selection != 2) {
                                                System.out.println("Try Again,invalid selection does not exist ");
                                                ...
                                                case 1:
                                                    for (int i = 0; i < Staffarr.length; i++) {
                                                        if (Staffarr[i] instanceof Manager) {
                                                            System.out.println("\t\t\t\t\t\t" + Staffarr[i].getName() + "'s salary is RM " + ((Manager) Staffarr[i]).CalcSalary());
                                                        }
                                                    }
                                                    break;
                                                case 2:
                                                    for (int i = 0; i < Staffarr.length; i++) {
                                                        if (Staffarr[i] instanceof ConcertAdmin) {
                                                            System.out.println("\t\t\t\t\t" + Staffarr[i].getName() + "'s salary is RM " + ((ConcertAdmin) Staffarr[i]).CalcSalary());
                                                        }
                                                    }
                                                    break;
                                                case 3:
                                                    for (int i = 0; i < Staffarr.length; i++) {
                                                        if (Staffarr[i] instanceof ConcertStocker) {
                                                            System.out.println("\t\t\t\t\t" + Staffarr[i].getName() + "'s salary is RM " + ((ConcertStocker) Staffarr[i]).CalcSalary());
                                                        }
                                                    }
                                                    break;
                                        ...
                                        case 2:
                                            ...
                                            switch (choose) {
                                                ...
                                                case 1:
                                                    ...
                                                    System.out.println("\t\t\t\t\t\t" + Staffarr[1].getName() + "'s salary after addition is RM " + Staffarr[1].getBasicSalary());
                                                    break;
                                                case 2:
                                                    ...
                                                    System.out.println("\t\t\t\t\t\t" + Staffarr[2].getName() + "'s salary after addition is RM " + Staffarr[2].getBasicSalary());
                                                    break;
